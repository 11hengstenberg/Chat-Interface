...
public:
    ...
    void retranslateUi(QDialog *Dialog)
    {
        ...
        label->setText(QApplication::translate("Dialog", "<html><head/><body><p align=\"center\"><span style=\" font-size:28pt; font-weight:600;\">RMBT CHAT</span></p", Q_NULLPTR));
        label_2->setText(QApplication::translate("Dialog", "<html><head/><body><p align=\"center\"><span style=\" font-size:24pt; font-weight:600;\">ID:</span></p></body></html>", Q_NULLPTR));
        ...
        pushButton_3->setText(QApplication::translate("Dialog", "ENTRAR", Q_NULLPTR));
    } // retranslateUi
